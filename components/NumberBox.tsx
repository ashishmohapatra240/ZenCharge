  ...
  return (
    <div className="flex flex-col items-center mt-4 px-2">
      ...
      <div className="relative bg-transparent flex flex-col items-center justify-center rounded-lg w-32 h-32 text-2xl md:text-4xl mt-4"
        ...
        {/* Number Display */}
        <div className="text-5xl absolute text-rose-500 z-10 font-bold md:text-7xl font-mono">
          {num}
        </div>
        ...
        {/* Flip Animation */}
        <div
          className={`absolute w-full h-1/2 top-0 rounded-t-lg z-5 transition-transform transform-gpu ${
            flip ? "animate-flip bg-rose-200" : "bg-transparent"
          }`}
          style={{ transformStyle: "preserve-3d" }} /* Ensure 3D flip */
        ></div>
